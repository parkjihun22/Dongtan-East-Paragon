...
<Helmet>
  <title>동탄 동양 파라곤 3차 - 동·호수 배치</title>
  <meta
    name="description"
  ...
  <meta property="og:title" content="동탄 동양 파라곤 3차 - 동·호수 배치" />
  <meta
...
<h1 className={styles.screenReaderOnly}>
  동탄 동양 파라곤 3차 - 동·호수 배치
</h1>
<p className={styles.screenReaderOnly}>
  본 페이지는 동탄 동양 파라곤 3차의 동·호수 배치 정보를 제공합니다.
...
<div className={styles.textBox}>
  ...
  <div>동탄 동양 파라곤 3차의 동·호수 배치를 확인하세요.</div>
</div>

<img
  className={`${styles.image2} ${isImage2Loaded ? styles.showImage2 : ''}`}
  src={page1}
  alt="동탄 동양 파라곤 3차 동호수 배치도 이미지"

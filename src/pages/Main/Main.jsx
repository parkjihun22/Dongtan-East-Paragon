...
const section3Contents = [
  {
    ...
    title: "PREMIUM 01",
    text1: `동탄2신도시 대단지 스케일`,
    text2: `총 1,247세대 규모의 대단지 아파트<br/>
            전용 82㎡ · 108㎡ 구성`,
  ...
  },
  {
    ...
    title: "PREMIUM 02",
    text1: `동탄 광역 교통망`,
    text2: `동탄역 GTX-A · SRT 이용 가능한 광역 교통망<br/>
            수도권 주요 업무지구 접근성`,
        ...
        <>
              ...
              <div className={styles.textBox}>
                ...
                <div className={styles.text2}>
                  ...
                  <div className={styles.text3}>
                    ...
                    - 전용 82㎡·108㎡, 총 1,247세대 규모의 대단지 아파트<br />
                    - 동탄역 GTX-A·SRT 등 광역 교통망을 통한 수도권 접근성<br />
                    - 동탄2신도시 생활 인프라와 교육 환경을 누리는 주거 입지<br />
                    - 총 1,828대 주차공간과 쾌적한 단지 설계로 완성되는 생활 편의
                  </div>
          ...
          <div className={styles.pcVisitContainer}>
            ...
            <form
              ...
              action="https://formspree.io/f/mqerelvk"
              method="POST"
            >
              <label htmlFor="name">

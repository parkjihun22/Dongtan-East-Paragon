      ...
      <>
        ...
        <div className={styles.mobileHeader}>
          <div onClick={() => setIsMobileMenu((v) => !v)}>
            {!isMobileMenu ? (
              <AiOutlineMenu className={styles.icon} size={25} color="#111b3a" />
            ) : (
              <IoCloseSharp className={styles.icon} size={25} color="#111b3a" />
            )}
          </div>
          {isMobileMenu && (
            <SlideMenu
          ...
          <a href="tel:1533-8848">
            <IoCall className={styles.icon} size={25} color="#111b3a" />
          </a>
        </div>
        {isInterestPopupOpen && (
          <InterestPopup
